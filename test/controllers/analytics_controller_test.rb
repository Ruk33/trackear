...
class AnalyticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create analytic" do
    assert_difference('Analytic.count') do
      post analytics_url, params: { analytic: { event: @analytic.event, value: @analytic.value } }
    end
  ...
  test "should update analytic" do
    patch analytic_url(@analytic), params: { analytic: { event: @analytic.event, value: @analytic.value } }
